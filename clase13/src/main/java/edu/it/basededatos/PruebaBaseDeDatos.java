...
public class PruebaBaseDeDatos {
	...
	public List<AlumnoDTO> obtenerAlumnos(Connection conn) throws SQLException {
		ArrayList<AlumnoDTO> listAlu = new ArrayList<AlumnoDTO>();
	...
	public void insertar(Connection conn, AlumnoDTO alumno) throws SQLException {
